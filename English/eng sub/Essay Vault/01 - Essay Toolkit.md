...
```
Para 1 — Introduction: define topic, state importance, thesis statement
Para 2 — Point 1: idea + explanation + example
Para 3 — Point 2: idea + explanation + example
Para 4 — Point 3: idea + explanation + example
Para 5 — Conclusion: summarize, opinion, closing thought/call to action
```

## A5. Strong Verbs

address, tackle, foster, cultivate, undermine, bolster, hinder, propel, mitigate, exacerbate, curb, safeguard, uphold, advocate, champion, jeopardize

## A6. Conclusion Power Phrases

- "In light of the above discussion..."
- "Taking everything into account..."
- "It is imperative that..."
- "Only through concerted efforts can..."
