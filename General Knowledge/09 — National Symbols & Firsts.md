...
## Quick Additional Facts Not in Other Vaults

| Question | Answer |
|----------|--------|
| First nuclear test India | **Pokhran, 1974 — Operation Smiling Buddha** |
| Second nuclear test | **Pokhran II, 1998 — Operation Shakti** |
| National Motto | **Satyameva Jayate** (Truth alone triumphs) — from Mundaka Upanishad |
| "Satyameva Jayate" taken from | **Mundaka Upanishad** |
| Vande Mataram first sung at | **INC session 1896** |
| Jana Gana Mana first sung at | **INC session 1911 (Calcutta)** |
| National Flag designed by | **Pingali Venkayya** |
| Ashoka Chakra on flag has | **24 spokes** |
| Flag ratio (width to length) | **2:3** |
| Flag colors | Saffron (top), White (middle), Green (bottom) |
