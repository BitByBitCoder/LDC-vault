...
# Official Languages, Administrative Tribunals, Anti-Defection Law, Political Parties
...
| Question | Answer |
|---|---|
| Criteria for recognition as a National Party? | ||At least 6% of valid votes in 4+ states in a general election (LS or Assembly) AND at least 4 LS seats from any state(s)|| |
| Criteria for recognition as a State Party? | ||At least 6% of valid votes in the state (LS or Assembly election) AND minimum 2 seats in that State's Assembly|| |

## NCRWC & RTI

| Question | Answer |
|---|---|
| What does NCRWC stand for, when set up, headed by whom? | ||National Commission to Review the Working of the Constitution; set up 2000; headed by M.N. Venkatachaliah|| |
| How many members did NCRWC have, when did it submit its report? | ||11 members; report in 2002|| |
| When did RTI Act come into force? | ||12 October 2005|| |
| Who appoints the Chief Information Commissioner, on whose recommendation? | ||President, on recommendation of a committee (PM, Leader of Opposition in LS, a Union Cabinet Minister nominated by PM)|| |

## Exam Trap ⚠️
- Anti-defection "split" exception (33% breakaway) was itself REMOVED by the 91st Amendment (2003) in practice — but this source still states the general split exemption; verify latest position, since 91st Amendment tightened defection rules considerably.
- National Party needs BOTH the 6% vote criterion AND the 4-seat criterion — missing either disqualifies.
