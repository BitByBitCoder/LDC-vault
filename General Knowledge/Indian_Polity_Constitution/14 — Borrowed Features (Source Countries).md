...
> This is a **very high frequency** topic in LDC exams. 1 question appears almost every paper.
...
| Directive Principles borrowed from | **Ireland** |
| Parliamentary system borrowed from | **Britain (UK)** |
| Single citizenship borrowed from | **Britain (UK)** |
| Amendment procedure borrowed from | **South Africa** |
| Fundamental Duties borrowed from | **USSR (Soviet Union)** |
| Concurrent List borrowed from | **Australia** |
| Judicial Review borrowed from | **USA** |
| Freedom of speech concept | **USA** |
| Preamble concept borrowed from | **USA** |
...
| **UK** | Parliament + Single citizenship + Rule of Law + Writs |
| **Canada** | Federation + Strong Centre + Residuary to Centre |
| **Ireland** | DPSP + RS Nomination |
| **Germany** | Emergency + Suspension of FR |
...
## Exam Traps ⚠️
> Federal system = **Canada** — NOT USA (USA has dual citizenship, India follows Canada's model of strong centre)
> Emergency provisions = **Germany** — NOT USA or UK
> DPSP = **Ireland** — NOT USA or UK
> Fundamental Duties = **USSR** — NOT USA
> Preamble concept = **USA** — "We the People" style
